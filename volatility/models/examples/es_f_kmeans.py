...
ticker = pd.read_parquet('C:\\Users\\nicho\PycharmProjects\ml_ensembles\models\data\es_f.parquet')
...
model = wkf(OHLC_data=daily_data.dropna(), k=3, max_iter=20, tol=1e-5, gamma=5, mmd_pairs=12)
model.fit_windows(h1=60, h2=10)
